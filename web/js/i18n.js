export const I18N = {
  fr:{
    ...
    ug_btn:"Vérifier", ug_dl:"Télécharger la mise à jour", ug_none:"Aucune mise à jour disponible.", ug_pill:"Mettre à jour le jeu",
    ug_checking:"Vérification…", ug_found:"Mise à jour disponible.",
    ...
    diag_desc:"Enregistre logs, réglages et détails d'installation dans un zip à joindre à un rapport de bug.",
  ...
  en:{
    ...
    ug_btn:"Check", ug_dl:"Download update", ug_none:"No update available.", ug_pill:"Update the game",
    ug_checking:"Checking…", ug_found:"Update available.",
    ...
    diag_desc:"Saves logs, settings and install details into one zip to attach to a bug report.",
