export const I18N = {
  fr:{
    online:"EN LIGNE",
    chip:"ÉPISODE",
    play:"LANCER", play_install:"INSTALLER", play_repair:"RÉPARER",
    ...
    ug_btn:"Vérifier", ug_dl:"Télécharger la mise à jour", ug_none:"Aucune mise à jour",
  ...
  en:{
    online:"ONLINE",
    chip:"EPISODE",
    play:"PLAY", play_install:"INSTALL", play_repair:"REPAIR",
    ...
    ug_btn:"Check", ug_dl:"Download update", ug_none:"No update",
